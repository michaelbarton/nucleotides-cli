Feature: Fetching input data files for benchmarking
  ...
  Scenario: Fetching input data files for short read assembly task
    When I run `nucleotides fetch-data 9`
    ...
    And the file "nucleotides/9/inputs/short_read_fastq/11948b41d44931c6a25cabe58b138a4fc7ecc1ac628c40dcf1ad006e558fb533.fq.gz" should exist
